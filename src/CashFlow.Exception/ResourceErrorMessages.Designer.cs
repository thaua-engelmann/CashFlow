...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Date must not be in the future..
        /// </summary>
        public static string DATE_MUST_NOT_BE_FUTURE {
            get {
                return ResourceManager.GetString("DATE_MUST_NOT_BE_FUTURE", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Expense was not found..
        /// </summary>
